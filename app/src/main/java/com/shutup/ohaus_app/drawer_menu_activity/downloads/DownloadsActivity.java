...
public class DownloadsActivity extends BaseActivity implements Constants {
    ...
    private DownloadsListAdapter mListAdapter;
    ...
    private void initList() {
        ...
        mListAdapter = new DownloadsListAdapter(mNormalItems);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), mRecyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                if (currentType == ACTIVITY_NORMAL) {
                    Toast.makeText(DownloadsActivity.this, "clicked", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.select_all_btn:
                if (BuildConfig.DEBUG) Log.d("DownloadsActivity", "all");
                selectAll((Button) view);
                break;
            case R.id.delete_selected_btn:
                deleteSelected();
                if (BuildConfig.DEBUG) Log.d("DownloadsActivity", "delete");
                break;
        }
    }
