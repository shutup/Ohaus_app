 ...
 */
public class IndustryApplicationMenuAdapter extends RecyclerView.Adapter<IndustryApplicationMenuAdapter.ViewHolder> {
    private ArrayList<IndustryApplicationMenuItem> mIndustryApplicationMenuItems;
    private Context mContext;

    public IndustryApplicationMenuAdapter(Context context, ArrayList<IndustryApplicationMenuItem> industryApplicationMenuItems) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.industry_application_menu_item_layout, parent, false);
